...
public class BlockedPRMap extends MapReduceBase 
	...
	public void map(LongWritable key, Text value,
		...
		output.collect(new LongWritable(Block.getBlockNumber(fromNode)), new Text(redText.toString()));
		if(toNode!= -1) {
			output.collect(new LongWritable(Block.getBlockNumber(toNode)), new Text(redText.toString()));
		}		
	}
}
